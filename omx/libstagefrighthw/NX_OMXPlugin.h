...
#ifndef __NX_OMXPLUGIN_H__
#define __NX_OMXPLUGIN_H__

#include <OMXPluginBase.h>

namespace android {

struct NX_OMXPlugin : public OMXPluginBase {
    NX_OMXPlugin();
    virtual ~NX_OMXPlugin();
...
private:
    ...
    NX_OMXPlugin(const NX_OMXPlugin &);
    NX_OMXPlugin &operator=(const NX_OMXPlugin &);
};

}  // namespace android

#endif  // __NX_OMXPLUGIN_H__
