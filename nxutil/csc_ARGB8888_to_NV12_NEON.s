    ...
    .arch armv7-a
    .text
    .global csc_ARGB8888_to_NV12_NEON
    .type   csc_ARGB8888_to_NV12_NEON, %function
csc_ARGB8888_to_NV12_NEON:
    .fnstart
...
LOOP_NWIDTH16:
   ...
   @-------------------------------------------YUV ------------------------------------------
    ...
    vtrn.8 q7,q8
    vst1.8  {q7}, [r1]!    @write UV component to yuv420_buffer+linear_ylanesiez
