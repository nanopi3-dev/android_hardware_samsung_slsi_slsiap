...
struct nxp_vid_buffer {
    ...
    unsigned long stride[MAX_BUFFER_PLANES];
};
...
#define PIXFORMAT_RGB32             V4L2_PIX_FMT_RGB32
...
#define PIXINDEX2PIXFORMAT(pixindex)    PixelArray[pixindex].format
#define PIXINDEX2PIXCODE(pixindex)      PixelArray[pixindex].code
